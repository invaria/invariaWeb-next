              ...
              <>
                <div className="w-full z-40 h-[56px] bg-invar-dark flex justify-between items-center">
                  <p className=" ml-6 text-invar-error font-normal text-sm">
                    {t("homepage_pubilcsale_completekyc")}
                  </p>
                  <Link
                    href={{
                      pathname: "/dashboard",
            ...
            <div className="px-6 pb-4">
              ...
              <div className=" mt-4 flex justify-between items-baseline">
                <p className=" text-sm font-normal text-invar-light-grey ">
                  {t("homepage_pubilcsale_maxmintlimit")}
                </p>
                <p className=" text-base font-semibold text-white ">
                  {t("homepage_pubilcsale_nolimit")}
                </p>
              </div>
              <div className=" mt-4 flex justify-between items-baseline">
                <p className=" text-sm font-normal text-invar-light-grey ">
                ...
                <p className=" text-base font-semibold text-white ">
                  {t("homepage_pubilcsale_mintprice_usdceach")}
                </p>
              </div>
              <div className=" mt-4 flex justify-between items-baseline">
                <p className=" text-sm font-normal text-invar-light-grey ">
              ...
              {address && usdcAllowance >= 2000 && verify == "Accepted" && (
                <>
                  <p className=" mt-3 text-sm font-normal text-invar-light-grey ">
                    {t("homepage_pubilcsale_fillamount")}
                  </p>
                  <div className="relative ">
                    <input
                      type="number"
              ...
              <ul className="list-decimal pl-3 text-xs font-normal text-invar-light-grey mb-3">
                <li>{t("homepage_pubilcsale_note1")}</li>
                <li>{t("homepage_pubilcsale_note2")}</li>
                <li>{t("homepage_pubilcsale_note3")}</li>
                {readmore && (
                  <>
                    <li>{t("homepage_pubilcsale_note4")}</li>
                    <li>{t("homepage_pubilcsale_note5")}</li>
                    <li>
                      {t("homepage_pubilcsale_note6")} <ButtonMailto />.
                    </li>
                  </>
                )}
              </ul>
