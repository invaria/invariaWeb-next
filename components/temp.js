[
  ...
  },
  {
    ...
    name: "InVariaNFTBurn",
    outputs: [
      { internalType: "contract BurnFunction", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "burningInfo",
    outputs: [
      { internalType: "uint256", name: "burnableNFTamount", type: "uint256" },
      { internalType: "uint256", name: "leftToBurnNFTamount", type: "uint256" },
      { internalType: "uint256", name: "locktime", type: "uint256" },
      { internalType: "bool", name: "isBurn", type: "bool" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint256", name: "bal", type: "uint256" }],
    name: "stakeNFT",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    ...
    name: "stakingInfo",
    outputs: [
      { internalType: "uint256", name: "stakeNFTamount", type: "uint256" },
      {
        internalType: "uint256",
        name: "leftToUnstakeNFTamount",
        type: "uint256",
      },
