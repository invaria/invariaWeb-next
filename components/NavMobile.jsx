  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="nav-mobile-link w-full pt-4  flex flex-col justify-start items-start md:hidden text-white bg-gradient-to-b from-primary to-[#1E1722] overflow-scroll min-h-screen">
          <Link href="/dashboard">
            <MenuItem
              sx={{
                ...menuStyles,
          ...
          <MenuItem onClick={toggleDrawerHandler} sx={menuStyles} disabled>
            Learn
          </MenuItem>
