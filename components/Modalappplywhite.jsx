...
const Modalappplywhite = () => {
  ...
  if (endtimestamp < Date.now()) {
    btnAction = (
      ...
      {t("homepage_whitelistapply_applyuccess")}
      </div>
    );
    ...
    btnAction = (
      <button
        ...
        onClick={() => handleApply()}
      >
        {`${t("homepage_whitelistapply_applyuccess")} (${mintNum})`}
      </button>
    );
            ...
            <>
              <div className="w-full h-[56px] bg-invar-dark flex justify-between items-center">
                <p className=" ml-6 text-invar-error font-normal text-sm">
                 {t("homepage_whitelistapply_completekyc")}
                </p>
                <Link href="/dashboard">
                  <button
                  ...
                  >
                    {t("homepage_whitelistapply_verifykyc")}
                  </button>
                </Link>
              </div>
              <label
          ...
          <div className="px-6">
            ...
            <div className="mt-1 w-full p-4 bg-invar-main-purple rounded">
              ...
              <div className=" relative w-full mt-3 flex justify-between items-center group">
                ...
                >
                  {t("homepage_presalepage_addtoken")}
                </button>
              </div>
            </div>
            <div className=" mt-4 flex justify-between items-baseline">
              <p className=" text-sm font-normal text-invar-light-grey ">
               {t("homepage_whitelistapply_applytime")}
              </p>
            ...
            <div className=" mt-4 flex justify-between items-baseline">
              <p className=" text-sm font-normal text-invar-light-grey ">
               {t("homepage_whitelistapply_expectedamount")}
              </p>
              <p className=" text-base font-semibold text-white ">
              {t("homepage_whitelistapply_maxamount")}
              </p>
            </div>
            {/* <div className=" mt-4 flex justify-between items-baseline">
            ...
            {address && (
              <>
                <p className=" mt-3 text-sm font-normal text-invar-light-grey ">
                 {t("homepage_whitelistapply_fillamount")}
                </p>
            ...
            <ul className="list-decimal pl-3 text-xs font-normal text-invar-light-grey mb-3">
              <li>
                {t("homepage_whitelistapply_note1")}
              </li>
              <li>
              {t("homepage_whitelistapply_note2")}
              </li>
              <li>
              {t("homepage_whitelistapply_note3")}
              </li>
              {readmore && (
                <>
                  <li>
                  {t("homepage_whitelistapply_note4_1")}
                    <span>
                    ...
                    {t("homepage_whitelistapply_note4_2")}
                  </li>
                  <li>
                    {t("homepage_whitelistapply_note5")} <ButtonMailto />.
                  </li>
                </>
              )}
            </ul>
