  ...
  if (endtimestamp < Date.now()) {
    btnAction = (
      <div className="btn btn-disabled mt-6 bg-invar-disabled w-full h-[48px] font-semibold text-sm text-invar-light-grey border-none normal-case rounded">
        {intl.formatMessage({ id: 'homepage_whitelistapply_apply' })}
      </div>
    )
    ...
    btnAction = (
      <div className="w-full h-[76px] mt-6 bg-invar-dark p-4 text-sm text-invar-success font-normal flex justify-between items-center rounded shadow animate-fade-in-left">
        <p>
          {intl.formatMessage({ id: 'homepage_whitelistapply_applyuccess' })}
        </p>
        <button
            ...
            <>
              <div className="w-full h-[56px] bg-invar-dark flex justify-between items-center">
                <p className=" ml-6 text-invar-error font-normal text-sm">
                  {intl.formatMessage({
                    id: 'homepage_whitelistmintpage_completekyc',
                  })}
                </p>
                <Link href="/dashboard">
                  <button
                  ...
                  >
                    {intl.formatMessage({
                      id: 'homepage_whitelistmintpage_verifykyc',
                    })}
                  </button>
                </Link>
              </div>
          ...
          <div className="px-6">
            ...
            <div className=" mt-4 flex justify-between items-baseline">
              <p className=" text-sm font-normal text-invar-light-grey ">
                {intl.formatMessage({
                  id: 'dashbaord_activity_whiteapply_applytime',
                })}
              </p>
              <p className=" text-base font-semibold text-white text-end ">
                Sep 1, 00:00 ~ Oct 1, 00:00 (UTC+0)
              </p>
            </div>
            <div className=" mt-4 flex justify-between items-baseline">
              <p className=" text-sm font-normal text-invar-light-grey ">
                {intl.formatMessage({
                  id: 'homepage_whitelistapply_expectedamount',
                })}
              </p>
              <p className=" text-base font-semibold text-white ">
                {intl.formatMessage({
                  id: 'homepage_whitelistapply_maxamount',
                })}
              </p>
            </div>
            {/* <div className=" mt-4 flex justify-between items-baseline">
            ...
            {address && (
              <>
                <p className=" mt-3 text-sm font-normal text-invar-light-grey ">
                  {intl.formatMessage({
                    id: 'homepage_whitelistapply_fillamount',
                  })}
                </p>
            ...
            <ul className="list-decimal pl-3 text-xs font-normal text-invar-light-grey mb-3">
              <li>
                {intl.formatMessage({ id: 'homepage_whitelistapply_note1' })}
              </li>
              <li>
                {intl.formatMessage({ id: 'homepage_whitelistapply_note2' })}
              </li>
              <li>
                {intl.formatMessage({ id: 'homepage_whitelistapply_note3' })}
              </li>
              {readmore && (
                <>
                  <li>
                    {intl.formatMessage(
                      {
                        id: 'homepage_whitelistapply_note4',
                      },
                      {
                        p1: (str) => (
                  ...
                  <li>
                    {intl.formatMessage(
                      { id: 'homepage_whitelistapply_note5' },
                      {
                        mailto: () => <ButtonMailto />,
                      }
                    )}
