...
import { mintClosed, mintNotStarted, passAddress, tokensAvailable } from "../src/utils/web3utils";
                      ...
                      <div className="md:max-w-[327px] mx-auto">
                        <>
                          ...
                          <div className="relative ">
                            ...
                            {console.log("allowedToMint.current",allowedToMint.current)}
                            <button
                          ...
                          <>
                            {btnState === "minting" ? (
                              ...
                              <button
                                ...
                                disabled={
                                  !checked || mintNotStarted || mintNum < 1 ||limitExceeded
                                }
                              >
                                {`${t("mint")} (${mintNum})`}
                              </button>
