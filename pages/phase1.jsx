  ...
  return (
    <div className=" min-w-full max-w-full relative overscroll-none overflow-hidden h-full bg-gradient-radial from-[#55465D] to-black">
      ...
      <div className="relative">
        <img
          className="h-screen min-h-screen w-full object-cover"
          src="/bg/bg_phase0.png"
          alt="bg_phase0"
        />
        {/* <div className="hidden md:flex flex-col max-w-0 "> */}
        <img
          className=" cloud1 absolute top-56 md:top-[161px] -left-16 md:left-8 right-0 w-[700px] md:w-[700px] object-contain z-10"
          src="/cloud1.png"
          alt="cloud1"
        />
        <img
          className=" cloud2 absolute top-[380px] -right-20 md:right-0 w-[600px] md:w-[600px] object-contain z-10"
          src="/cloud2.png"
          alt="cloud2"
        />
        {/* </div> */}
        ...
        <div className="mt-[88px]  hidden absolute top-0 left-[24px] md:flex flex-row items-start justify-start h-[592px] w-[325px] text-white indent-0.5 font-normal text-sm z-10 animate-fade-in-down">
          ...
          <br />
          <br />
          Build up communication channel… Discord set up… Twitter launched… Now
          we can communicate, discuss with each others about InVaria and the
          ideas we have there!
        </div>
      ...
      <div className="relative bg-gradient-to-b from-invar-main-purple to-invar-dark text-white pb-12 md:pb-32">
        <div className="z-10">
          ...
          <div className="mx-[30px] sm:mx-[30px] md:mx-[130px] lg:mx-[230px] font-normal">
            <p>
              InVaria 2222 is a RWA-based, tokenization world with the goal of
              constructing connections between real-world and digital economies.
              In addition, InVaria 2222 is positioned as an experiment flagship
              of InVar Finance. Inside InVaria, a huge amount of opportunity and
              wealth are waiting for humanity to find out and enjoy; no one
              knows the whole picture of this world...
            </p>
            <br />
            <p>
              In phase one, a group of InVariants will build a tokenized real
              estate model first,
              <span id="faq"></span>
        ...
        <img
          className=" hidden md:flex absolute top-[1032px] -left-[136px] w-[600px] object-contain z-0"
          src="/bg/bg_02.png"
          alt=""
        />
        <img
          className=" hidden md:flex absolute top-[536px] -right-[60px] w-[450px] object-contain z-0"
          src="/bg/bg_03.png"
          alt=""
        />
        <img
          className=" hidden md:flex absolute bottom-[135.17px] left-[230px] w-[450px] object-contain z-0"
          src="/bg/bg_04.png"
          alt=""
        />
        <img
          className=" hidden md:flex absolute bottom-[0px] -left-[136px] w-[800px] object-contain z-0"
          src="/bg/bg_05.png"
          alt=""
        />
      </div>
