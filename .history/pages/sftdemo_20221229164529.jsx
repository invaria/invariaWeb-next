...
import vArrows from "../assets/images/v-arrows.png";
import hArrows from "../assets/images/h-arrows.png";
...
const RLOGIC = process.env.NEXT_PUBLIC_RLOGIC;
const RNFT = process.env.NEXT_PUBLIC_RNFT;
...
const SFTDemo = () => {
  ...
  const approve = async () => {
    ...
    try {
      ...
      result1.wait().then((receipt) => {
        if (receipt.blockNumber) erc20receiopt = true;
      });
      result1.wait().then((receipt) => {
  ...
  const RefreshData = async () => {
    ...
    setAlreadyApprovedForAll(isApprovedForAllForAll);
